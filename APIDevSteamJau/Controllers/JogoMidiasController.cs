...
namespace APIDevSteamJau.Controllers
{
    ...
    public class JogoMidiasController : ControllerBase
    {
        ...
        // GET: api/JogoMidias
        [HttpGet]
        public async Task<ActionResult<IEnumerable<JogoMidia>>> GetJogoMidia()
        {
            return await _context.JogoMidia.ToListAsync();
        }
        ...
        {
            var jogoMidia = await _context.JogoMidia.FindAsync(id);
        ...
        {
            _context.JogoMidia.Add(jogoMidia);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteJogoMidia(Guid id)
        {
            ...
            _context.JogoMidia.Remove(jogoMidia);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.JogoMidia.Any(e => e.JogoMidiaId == id);
        }
    }
}
